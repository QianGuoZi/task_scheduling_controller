...
if __name__ == '__main__':
	...
	emu2 = testbed.add_emulator ('emulator-2', '222.201.187.51', cpu=128, ram=256, unit='G')
	for i in range (1, 6):
		name = 'n' + str(i)
		dk = 'dml:v1.0'
		if i==5:
			name = 'p1'
		#	dk = 'dml:v2.0'
		en = testbed.add_emulated_node (name, '/home/qianguo/worker/dml_app',
			['python3', 'gl_peer.py'], dk, cpu=16, ram=2, unit='G', emulator=emu2)
